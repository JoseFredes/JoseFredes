...
<img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=700&size=28&duration=3000&pause=800&color=7C3AED&center=true&vCenter=true&width=620&lines=Hi%2C+I'm+Jos%C3%A9+Fredes;Software+Engineer;AI+Engineer;Quantum+Computing+Enthusiast+%F0%9F%9A%80" alt="typing" />

<br>

<img alt="Mikey" src="https://media3.giphy.com/media/jdFm2bcWlj4EUVCpc0/giphy.gif?cid=ecf05e47j569uca3a5zlgt7mydb3jvr50umwe2o9w9kwo3qn&rid=giphy.gif&ct=g" width="180" height="180" />
<img alt="Cyberpunk" src="https://compote.slate.com/images/4c33a890-6410-4ac8-b7a6-f0937c64e9a2.gif?crop=1200%2C800%2Cx0%2Cy0" width="270" height="180" />
<img alt="Gojo" src="https://i.pinimg.com/originals/40/14/02/4014020e00ed21c874cc6eb6949927bd.gif" width="180" height="180" />

<br><br>

<!-- Add your LinkedIn handle and uncomment:
...
-->
[![Gmail](https://img.shields.io/badge/Email-EA4335?style=for-the-badge&logo=gmail&logoColor=white)](mailto:josebmxfredes@gmail.com)
[![Profile views](https://komarev.com/ghpvc/?username=JoseFredes&style=for-the-badge&color=7C3AED&label=PROFILE+VIEWS)](https://github.com/JoseFredes)
...
const jose = {
  ...
  focus:     ["AI agents & agent security", "full-stack web", "quantum computing"],
  stack:     ["TypeScript", "Go", "Python", "Next.js", "Supabase", "Postgres"],
  cloud:     ["AWS", "GCP", "Cloudflare", "Vercel"],
  currently: "building agent tooling and dev infrastructure",
  motto:     "ship it, then make it beautiful",
};
```

- 🔭 Building **[mcp-inventory](https://github.com/JoseFredes/mcp-inventory)** — read-only inventory of the MCP tools your agents actually have loaded
- 🛡️ And **[recall-sdk](https://github.com/JoseFredes/recall-sdk)** — Signed Memory BOM SDK to detect, trace, and cascade-quarantine memory poisoning across an AI agent fleet (OWASP ASI06)
- 🦞 And **[openclaw](https://github.com/JoseFredes/openclaw)** — your own personal AI assistant. Any OS. Any platform.
- ⚛️ Exploring quantum computing (Qiskit, variational algorithms)
- 💬 Ask me about **AI agents, MCP, Claude Code, the Next.js App Router, or Supabase**
- 📫 Reach me at `josebmxfredes@gmail.com`
...
![Tauri](https://img.shields.io/badge/Tauri-24C8B8?style=for-the-badge&logo=tauri&logoColor=white)
...
<img src="https://raw.githubusercontent.com/JoseFredes/JoseFredes/output/snake.svg" alt="snake" />
